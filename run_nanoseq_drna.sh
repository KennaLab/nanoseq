...
#workflow_path='/hpc/hers_en/edejong2/software/nf_core/nf-core-nanoseq/3_1_0/'
workflow_path='/hpc/hers_en/edejong2/software/repos/nanoseq'
softwaretool_path='/hpc/hers_en/edejong2/software/'
...
basename_output=$(basename "${output}")
...
#SBATCH --job-name nextflow_nanoseq
#SBATCH -o log/slurm_nextflow_nanoseq.%j.out
#SBATCH -e log/slurm_nextflow_nanoseq.%j.err
#SBATCH --mail-user $email
#SBATCH --mail-type FAIL
#SBATCH --export=NONE

export NXF_JAVA_HOME='$softwaretool_path/tools/java/jdk'

${softwaretool_path}/tools/nextflow/nextflow run \
${workflow_path}/main.nf  \
-c ${workflow_path}/nextflow.config \
--input $input \
--outdir $output \
--email $email \
--multiqc_title $basename_output \
-resume \
-ansi-log false \
-profile slurm \
${optional_params[@]:-""}
